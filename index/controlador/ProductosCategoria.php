...
require_once('controlador2IndexCategoriaProd.php');
//require_once('Conexion.php');
//require_once('index/controlador/modeloIndex.php');
//require_once('index/modelo/modeloIndex.php');
...
$array_imagenes = array(
  "1" => "https://images.samsung.com/is/image/samsung/latin-hdtv-j4290-un32j4290ahxpa-frontblack-197309184?$720_576_PNG$",
  "6" => "https://www.lg.com/cac/images/televisores/md06125936/gallery/D_01_VF.jpg"
);
      ...
      <div class="carousel-item">
        ...
        <div class="container">
          <div class="carousel-caption">
            <h1>El Telefono Definitivo.</h1>
            <p>El MI MIX 4 debe ser tuyo!.</p>
            <p><a class="btn btn-lg btn-primary" href="#">Ver Detalles</a></p>
          </div>
        </div>
      </div>
      <div class="carousel-item">
        ...
        <div class="container">
          <div class="carousel-caption text-end">
            <h1>samsung smart tv 8k HDR.</h1>
            <p>La mejor tecnologia del entretenimiento con la mejor calidad en imagen.</p>
            <p><a class="btn btn-lg btn-primary" href="#">Ver Detalles</a></p>
          </div>
        </div>
      </div>
  ...
  <div class="container marketing">
    ...
    <?php foreach ($categoriaProductos as $CategoriaProducto): ?>
      ...
      <svg class="bd-placeholder-img rounded-circle" width="100" height="100" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: 140x140" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#777"/><text x="50%" y="50%" fill="#777" dy=".3em">140x140</text></svg> <br>
        <img width="200" src="<?php echo $array_imagenes[$CategoriaProducto['Id_Producto']] ?>" alt="imagen" />        
        <?php echo  "<h2> ". $CategoriaProducto['Nombre_Producto'];  "</h2>" ?>
        <?php echo "<p> ". $CategoriaProducto['Marca_Producto']; "</p> "?> 
        <?php echo "<p> ". $CategoriaProducto['Valor_Unitario_Producto']; "</p> "?>	 	            
        <p><a class="btn btn-secondary" name="btnProducto" href="/Proyecto_Ev/producto/vista/productoDetalleVenta.php?Id_Producto=<?php echo $CategoriaProducto['Id_Producto'] ?>">Detalle &raquo;</a></p>
      </div><!-- /.col-lg-4 --> 
      <?php endforeach; ?>
   <div>
